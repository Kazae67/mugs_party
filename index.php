 ...
 *
 * Créer un repository (public) mugs_party sur ton github personnel. (à faire à la fin)
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <li class="nav-item active">
                        <a class="nav-link" href="/">Mugs Party <span class="sr-only">(current)</span></a>
                    <li class="nav-item active">
  ...
  <form class="form-inline" action="/recherche/" method="get">
    <fieldset>    
      <div class="input-group">
        ...
        Tendances: 
          <select id="oCategorie" name="oCategorie" class="form-control">
            <option selected="selected" value="6">All</option>
            <option value="1">Oui</option>
            <option value="2">Non</option>
          </select>
       ...
       <!--  <input id="oSaisie" name="oSaisie" type="text" class="form-control" aria-label="Saisie de mots clés" required="required">
        <div class="input-group-append">
          <button class="btn btn-primary" type="submit">Recherche</button> -->
                  ...
                  <!-- Bouttons -->  
        <button type="submit" class="btn btn-outline-success "><b>Trier</b></button>
        <button type="submit" class="btn btn-outline-danger "><b>Reset</b></button>
        </div>
        </div>
      </div>
    </fieldset> 
    ...
    <div class="container">
          ...
          <ul id="party-flters">
            <data-filter="*" class="filter-active">
